draft.html: draft.Rmd results/img/time_series.png results/img/first_year.png results/tab/reg_table.html results/img/more_data.png
...
results/img/more_data.png: scripts/04_figure_3.R data/clean_fish_data.rds
